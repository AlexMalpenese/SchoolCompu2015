...
// Below is the first picture and there is an event listener that explains the picture when it is clicked.
lego.addEventListener("click", function(){
 ...
 // Below is the second picture and there is an event listener that explains the picture when it is clicked.                      
...
// Below is the third picture and there is an event listener that explains the picture when it is clicked.
...
// Below is the fourth picture and there is an event listener that explains the picture when it is clicked.
